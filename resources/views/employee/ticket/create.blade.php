                        ...
                        <form method="POST" action="{{ route('employee.ticket.store') }}">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label for="fname">Select Client</label> <br>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input required name="street_address_1" type="text" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select required id="category" name="department_id" class="selectpicker form-control"
                                        data-style="py-0">
                                ...
                                <div class="form-group col-sm-6">
                                    ...
                                    <select required name="priority" class="selectpicker form-control" data-style="py-0">
                                ...
                                <div class="form-group col-12 mt-2">
                                    <div class="custom-file">
                                        <input type="file"
                                            ...
                                            multiple name="images[]" class="custom-file-input" id="images">
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.images.forEach(element => {
                        ...
                        `;
                            $('#product-gallery').append(html)
                        } else if (element.ext == 'docx') {
                            let html = `
                            <div class="col-lg-3 col-md-4 col-sm-6" id="image-row-${element.image_id}">
                                <div class="dropzoneimg p-2">
                                    <a href="${element.image_path}" download>Download Word File</a>
                                    <input readonly type="text" hidden name="images_array[]" value="${element.image_id}">
                                    <div class="card-body">
                                        <a onclick="deleteImae(${element.image_id})" class="img-delte-btn">Delete</a>
                                    </div>
