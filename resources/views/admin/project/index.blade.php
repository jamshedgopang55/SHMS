                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                <div id="circle-progress-0{{ $project->id }}"
                                    ...
                                    data-min-value="0" data-max-value="100" data-value="{{ $project->progress }}"
                                    data-type="percent">
                                </div>
                            ...
                            <p class="mb-3 mt-2" style="display: flex !important;gap:15px"> <span
                                    class="date">{{ $project->start_date }}</span> _ To _ <span
                                    class="date">{{ $project->end_date }}</span></p>
                                    <a href="{{route('admin.milestone.index',$project->id)}}">MileStone</a>
                            <div class="d-flex align-items-center justify-content-between pt-3 border-top">
                                ...
                                <a class="btn btn-primary prj-btn"
                                    href="{{ route('admin.project.edit', $project->id) }}">View Or Edit</a>


                                <button style="text-transform: capitalize"
                                    @if ($project->priority == 'high') class="btn btn-danger"
                            @elseif($project->priority == 'medium')
                            class="btn btn-warning"
                            @else 
                            class="btn btn-info" @endif>{{ $project->priority }}
                                </button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 text-sm-right mt-3 mt-sm-0">
                                <div class="iq-media-group">
                                    ...
                                    <a href="#" class="iq-media">
                                        <img class="img-fluid avatar-40 rounded-circle" src="../assets/images/user/04.jpg"
                                            alt="">
                                    </a>
                                    <a href="#" class="iq-media">
                            ...
                            <div class="col-sm-8">
                                <div class="d-flex align-items-center">
                                    <div id="circle-progress-15"
                                        ...
                                        data-min-value="0" data-max-value="100" data-value="15" data-type="percent">
                                    </div>
                                    <div class="ml-3">
