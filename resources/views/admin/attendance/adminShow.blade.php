                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($attendance->attendance_status == 'absent')
                                        ...
                                        <td style="color: red;">Absent</td>
                                        <td style="color: red;">Absent</td>
                                        <td style="color: red;">Absent</td> <!-- Add an extra cell for the attendance status -->
                                    @elseif ($attendance->attendance_status == 'holiday')
                                        <td style="color: green;">Holiday</td>
                                        <td style="color: green;">Holiday</td>
                                        <td style="color: green;">Holiday</td>
                                        <td style="color: green;">Holiday</td> <!-- Add an extra cell for the attendance status -->
                                    @else
                                        <td style="color: {{ $attendance->check_in_status == 'late' ? 'red' : 'green' }}">{{ $attendance->in_time }} ({{ $attendance->check_in_status }})</td>
                                        <td style="color: {{ $attendance->check_out_status == 'late' ? 'red' : 'green' }}">{{ $attendance->out_time }} ({{ $attendance->check_out_status }})</td>
