            ...
            <form action="{{ route('admin.milestone.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6" >
                        ...
                        <input required type="date" id="due_date" name="due_date" class="form-control" required>
                    </div>
                    <div class="form-group col-md-6" >
                        <label for="late_time">Price</label>
                        <input required type="number" id="price" name="price" class="form-control" required>
                    </div>
